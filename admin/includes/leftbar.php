...
<li><a href="manage-bloodgroup.php">Manage Blood Group</a></li>
				...
				<li><a href="manage-conactusquery.php"><i class="fa fa-desktop"></i> Manage Contact tus Query</a></li>
			<li><a href="manage-pages.php"><i class="fa fa-files-o"></i> Manage Pages</a></li>a
