...
if (empty($_SESSION['bbdmsdid'])) {
    header('Location: logout.php');
    exit();
} else {
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update'])) {
        $userId = $_SESSION['bbdmsdid'];
        $updateData = [
            'FullName' => filter_input(INPUT_POST, 'fullname', FILTER_SANITIZE_STRING),
            'MobileNumber' => filter_input(INPUT_POST, 'mobileno', FILTER_SANITIZE_STRING),
        ...
        $sql = "UPDATE tblblooddonars SET $placeholders WHERE id = :userId";
        ...
        try {
            ...
            echo "<script>alert('An error occurred while updating the profile. Please try again.');</script>";
        }
    }
}
?>
