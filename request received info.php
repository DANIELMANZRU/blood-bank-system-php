...
// Check if the user is logged in, if not, redirect to logout page
if (empty($_SESSION['bbdms_donor_id'])) {
...
<head>
    ...
    <title>Blood Donation Management System - Received Requests</title>
